...
<!-- Mirrored from mediqu.dexignzone.com/xhtml/table-datatable-basic.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 03 Jan 2021 14:51:51 GMT -->
<head>
    <meta charset="utf-8">
    ...
    <!-- Datatable -->
    <link href="{{ asset('doc/vendor/datatables/css/jquery.dataTables.min.css') }}" rel="stylesheet">
    <!-- Custom Stylesheet -->
...
<body>
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table id="example3" class="display" style="min-width: 845px">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td><img class="rounded-circle" width="35" src="{{ asset('doc/images/profile/small/pic1') }}.jpg" alt=""></td>
                                                <td>Tiger Nixon</td>
                                                <td>Architect</td>
                                                <td>Male</td>
                                                <td>M.COM., P.H.D.</td>
                                            ...
                                            <tr>
												<td><img class="rounded-circle" width="35" src="{{ asset('doc/images/profile/small/pic2') }}.jpg" alt=""></td>
                                                <td>Garrett Winters</td>
                                                <td>Accountant</td>
                                                <td>Female</td>
                                                <td>M.COM., P.H.D.</td>
                                            ...
                                            <tr>
												<td><img class="rounded-circle" width="35" src="{{ asset('doc/images/profile/small/pic3') }}.jpg" alt=""></td>
                                                <td>Ashton Cox</td>
                                            ...
                                            <tr>
												<td><img class="rounded-circle" width="35" src="{{ asset('doc/images/profile/small/pic4') }}.jpg" alt=""></td>
                                                <td>Cedric Kelly</td>
                                                <td>Developer</td>
                                                <td>Male</td>
												<td>B.COM., M.COM.</td>
                                            ...
                                            <tr>
												<td><img class="rounded-circle" width="35" src="{{ asset('doc/images/profile/small/pic5') }}.jpg" alt=""></td>
                                                <td>Airi Satou</td>
                                                <td>Accountant</td>
                                                <td>Female</td>
												<td>B.A, B.C.A</td>
                                            ...
                                            <tr>
												<td><img class="rounded-circle" width="35" src="{{ asset('doc/images/profile/small/pic6') }}.jpg" alt=""></td>
                                                <td>Brielle Williamson</td>
                                                <td>Specialist</td>
                                                <td>Male</td>
												<td>B.COM., M.COM.</td>
                                            ...
                                            <tr>
												<td><img class="rounded-circle" width="35" src="{{ asset('doc/images/profile/small/pic7') }}.jpg" alt=""></td>
                                                <td>Herrod Chandler</td>
                                                <td>Sales Assistant</td>
                                                <td>Female</td>
												<td>B.A, B.C.A</td>
                                            ...
                                            <tr>
												<td><img class="rounded-circle" width="35" src="{{ asset('doc/images/profile/small/pic8') }}.jpg" alt=""></td>
                                                <td>Rhona Davidson</td>
                                                <td>Integration</td>
                                                <td>Male</td>
												<td>B.TACH, M.TACH</td>
                                            ...
                                            <tr>
												<td><img class="rounded-circle" width="35" src="{{ asset('doc/images/profile/small/pic9') }}.jpg" alt=""></td>
                                                <td>Colleen Hurst</td>
                                                <td>Javascript Developer</td>
                                                <td>Female</td>
												<td>B.A, B.C.A</td>
                                            ...
                                            <tr>
												<td><img class="rounded-circle" width="35" src="{{ asset('doc/images/profile/small/pic10') }}.jpg" alt=""></td>
                                                <td>Sonya Frost</td>
                                                <td>Software Engineer</td>
                                                <td>Male</td>
												<td>B.COM., M.COM.</td>
    ...
    ***********************************-->
    ...
    <!-- Datatable -->
    <script src="{{ asset('doc/vendor/datatables/js/jquery.dataTables.min.js') }}"></script>
    <script src="{{ asset('doc/js/plugins-init/datatables.init.js') }}"></script>
...
<!-- Mirrored from mediqu.dexignzone.com/xhtml/table-datatable-basic.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 03 Jan 2021 14:51:54 GMT -->
</html>